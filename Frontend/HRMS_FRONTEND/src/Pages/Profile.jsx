     ...
     <div className="flex flex-col items-center gap-4 p-6">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="bg-white rounded-2xl shadow p-6">
          <h2 className="text-2xl text-center font-semibold mb-4">Employee Profile</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-lg font-medium">{Employee?.joiningDate}</p>
            </div>
            <div>
             ...
             <div>
              ...
              <p className="text-lg font-medium">{Employee?.mangerName == null ? "NA":Employee.mangerName}</p>
            </div>
        </div>
       </div>
    </div>
